...
public class TextUI {
    ...
    public void start() {
        /*
         * lets start in two parts
         * first start the asset control
    ...
    private void startAssetControl() {
        ...
        while (true) {
            ...
            if(answer.equals("1")) addAirplane();
            else if(answer.equals("2")) addFlight();
    ...
    private void addFlight() {
        ...
        System.out.print("Give the target airport: ");
    ...
    private void startFlightControl() {
        ...
        while (true) {
            ...
            System.out.println("> ");
            String answer = scanner.nextLine();
            if(answer.equals("1")) printAirplanes();
            else if(answer.equals("2")) printFlights();
            else if(answer.equals("3")) printAirplaneDetails();
            else if(answer.equals("4")) break;
        }
    }
